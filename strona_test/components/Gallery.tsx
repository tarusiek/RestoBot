    ...
    <section id="gallery" className="py-24 bg-muted/20 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            <span className="text-primary uppercase tracking-[0.2em] text-xs font-semibold mb-4 block">Atmosfera</span>
            <h2 className="text-4xl md:text-5xl font-heading text-white">Wnętrze & Detale</h2>
          </div>
          <a
            href="https://instagram.com/bistrowarszawacafe"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm tracking-widest uppercase text-muted-foreground hover:text-white transition-colors border-b border-white/20 pb-1"
          >
            @bistrowarszawacafe
          </a>
        </div>
